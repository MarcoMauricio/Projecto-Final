...
Array.prototype.add = function (val, idx) {
    if (idx == undefined)
        this.push(val);
    else {
...
Array.prototype.replace = function (val, fn) {
    for (var i = 0; i < this.length; i++) {
        if (fn(this[i])) {
            this.splice(i, 1, val);
            return;
...
if (!Array.prototype.forEachAsync) {
    Array.prototype.forEachAsync = function (fn, callback) {
        ...
        var cb = function () {
            ...
            fn.call(self, this[i], i, this, function () {
                cb.call(self);
            });
        };
        cb.call(self);
