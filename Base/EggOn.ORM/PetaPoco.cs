...
using FlowOptions.EggOn.DataHost.DatabaseTypes;
using FlowOptions.EggOn.DataHost.Internal;
using System;
...
namespace FlowOptions.EggOn.DataHost
{
	...
	public class Database : IDisposable
	{
        ...
        /// <summary>
        /// Fetches all entries in a table.
        /// </summary>
        /// <typeparam name="T">The Type representing a row in the result set</typeparam>
        /// <returns>A List holding the results of the fetch</returns>
        public List<T> All<T>()
        {
            return Fetch<T>("");
        }
			...
			try
			{
				...
				try
				{
					using (var cmd = CreateCommand(_sharedConnection, ""))
					{
						...
						var id = _dbType.ExecuteInsert(this, cmd, primaryKeyName);
	...
	namespace Internal
	{
		...
		class PocoData
		{
				...
				return PocoFactories.Get(key, () =>
					...
					if (type == typeof(object))
					{
						...
						for (var i = firstColumn; i < firstColumn + countColumns; i++)
						{
							...
							// Get the converter
							var converter = mapper.GetFromDbConverter((PropertyInfo)null, srcType);
			...
			private static void AddConverterToStack(ILGenerator il, Func<object, object> converter)
			{
				...
				{
					// Add the converter
					var converterIndex = _converters.Count;
		...
		static class AutoSelectHelper
		{
			public static string AddSelectClause<T>(DatabaseType DatabaseType, string sql)
			{
				...
				if (!rxSelect.IsMatch(sql))
				{
					...
					var cols = pd.Columns.Count != 0 ? string.Join(", ", (from c in pd.QueryColumns select tableName + "." + DatabaseType.EscapeSqlIdentifier(c)).ToArray()) : "NULL";
